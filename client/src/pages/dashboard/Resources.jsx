                    ...
                    <Row>
                        ...
                        <Container className='other-resources pt-5'>
                            <Row>
                                ...
                                <Col xs={12} md={4}>
                                    <Button onClick={ () => {window.open('http://www.suicide.org/international-suicide-hotlines.html')}}>Visit Website</Button>
                                </Col>
                            </Row>
                            <Row>
                                <Col xs={12} md={4}>
                                ...
                                <Col xs={12} md={4}>
                                    <Button onClick={ () => {window.open('https://www.dbsalliance.org/education/bipolar-disorder/')}}>Visit Website</Button>
                                </Col>
                            </Row>
                            <Row className='mb-5 p-1'>
                                ...
                                <Col xs={12} md={4}>
                                    <Button onClick={ () => {window.open('https://www.betterhelp.com/get-started/?go=true&transaction_id=102407124d401dea5cbaacc33b9dd2&utm_source=affiliate&utm_campaign=474&utm_medium=Desktop&utm_content=&utm_term=iw1&not_found=1&gor=start')}}>Visit Website</Button>
                                </Col>
                            </Row>
                        </Container>
                    </Row>
